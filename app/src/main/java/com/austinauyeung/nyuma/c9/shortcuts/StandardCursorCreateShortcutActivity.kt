...
class StandardCursorCreateShortcutActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        shortcutIntent.setClassName(packageName, "com.austinauyeung.nyuma.c9.shortcuts.StandardCursorActivity")

        val intent = Intent()
        intent.putExtra(Intent.EXTRA_SHORTCUT_INTENT, shortcutIntent)
        intent.putExtra(Intent.EXTRA_SHORTCUT_NAME, "Activate Standard Cursor")
